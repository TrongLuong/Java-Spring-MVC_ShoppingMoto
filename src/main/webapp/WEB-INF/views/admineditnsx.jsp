...
<body>
   ...
   <div class="row">  
    ...
    <h3 style="color: red;">${err }</h3>
         <form:form action="xulyeditmnsx" modelAttribute="nsxedit" method="post" role="form" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="example-text-input" class="col-3 col-form-label">Tên nhà sản xuất</label>
                    <div class="col-9">
                        <form:input  class="form-control" type="text"  path="tenNSX" value="${nsxedit.tenNSX }"/> 
                        <form:input hidden="true"   class="form-control" type="text"  path="maNSX" value="${nsxedit.maNSX }"/> 
                    </div>
                </div>
