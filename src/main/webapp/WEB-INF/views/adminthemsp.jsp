...
<body>
   ...
   <div class="row">  
    ...
    <h3 style="color: red;">${err }</h3>
         <form:form action="xulyadminthemsp" modelAttribute="sp" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <form:input class="form-control"    type="text"  required="true" path="moTaSp"/>
                    </div>
                </div>
                <div class="form-group row">
